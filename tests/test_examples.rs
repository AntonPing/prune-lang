...
#[test]
fn test_append_good() {
    let res = cli::pipeline::run_cli_test(PathBuf::from("./examples/sym_exec_good/append_good.pr"))
        .unwrap();
...
#[test]
fn test_append_bad() {
    let res = cli::pipeline::run_cli_test(PathBuf::from("./examples/sym_exec_bad/append_bad.pr"))
        .unwrap();
...
fn test_double_reverse_good() {
    let res = cli::pipeline::run_cli_test(PathBuf::from(
...
fn test_avl_tree_good() {
    let res =
        cli::pipeline::run_cli_test(PathBuf::from("./examples/sym_exec_good/avl_tree_good.pr"))
            .unwrap();
    assert!(res.iter().all(|p| *p == 0));
}
...
//     let res = cli::pipeline::run_cli_test(PathBuf::from("./examples/sym_exec_bad/avl_tree_bad.pr"))
//         .unwrap();
//     assert!(res.iter().any(|p| *p > 0));
// }
...
//     let res =
//         cli::pipeline::run_cli_test(PathBuf::from("./examples/sym_exec_bad/avl_tree_opt_bad.pr"))
//             .unwrap();
//     assert!(res.iter().any(|p| *p > 0));
// }
...
fn test_avl_tree_gen() {
    cli::pipeline::run_cli_test(PathBuf::from("./examples/test_gen/avl_tree_gen.pr")).unwrap();
}

#[test]
fn test_avl_tree_opt_gen() {
    cli::pipeline::run_cli_test(PathBuf::from("./examples/test_gen/avl_tree_opt_gen.pr")).unwrap();
}
...
fn test_stlc_term_gen() {
    cli::pipeline::run_cli_test(PathBuf::from("./examples/test_gen/stlc_term_gen.pr")).unwrap();
}

#[test]
fn test_mini_lang_gen() {
    cli::pipeline::run_cli_test(PathBuf::from("./examples/test_gen/mini_lang_gen.pr")).unwrap();
}
...
fn test_reverse_backward() {
    cli::pipeline::run_cli_test(PathBuf::from("./examples/basic/reverse_backward.pr")).unwrap();
}
...
#[test]
fn test_fermat_n3() {
    cli::pipeline::run_cli_test(PathBuf::from("./examples/other/fermat_n3.pr")).unwrap();
}

#[test]
fn test_unary_arith() {
    cli::pipeline::run_cli_test(PathBuf::from("./examples/arith/unary_arith.pr")).unwrap();
}
